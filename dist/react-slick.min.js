          ...
          C = function(e) {
            ...
            if (
              ...
              if (
                ...
                for (var w = 0, O = g; O < m.childNodes.length; O++)
                  w += m && m.children[O] && m.children[O].offsetWidth;
                w < p && 0 <= (t += p - w) && (t = 0);
              }
              if (!0 === a) {
                (g = o ? r + z(e) : r), (n = m && m.children[g]);
                for (var k = (t = 0); k < g; k++)
                  t -= m && m.children[k] && m.children[k].offsetWidth;
        ...
        var Ee = (function() {
            function e(t) {
              ...
              return (
                ...
                Te(Oe(n), "calcRealSlideShowed", function() {
                  var e = 0;
                  if (!n.props.infinite && n.props.variableWidth)
                    for (
                      var t = 0,
                        r = s.a.findDOMNode(n.track),
                        i = Math.ceil(v(s.a.findDOMNode(n.list))),
                      ...
                      if (
                        i <=
                        (t += r && r.children[o] && r.children[o].offsetWidth)
                      ) {
                        e = o - 2;
                        break;
                      }
                  n.setState({ slidesToShow: e || n.props.slidesToShow });
                }),
                ...
                (n.state = we({}, a, {
                  ...
                  slidesToShow: n.props.slidesToShow
                })),
                (n.callbackTimers = []),
                (n.clickable = !0),
